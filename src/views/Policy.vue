  ...
  <div class="_base-w">
    ...
    <div class="_content-w">
      ...
      <div class="t_container">
        <p class="t_title">第1条（個人情報）</p>
        <p class="t_text">
          「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，住所，メールアドレスその他の記述等により特定の個人を識別できる情報（個人識別情報）を指します。
          </p>
      </div>
      <div class="t_container">
        <p class="t_title">第2条（個人情報の収集方法）</p>
        <p class="t_text">
          当サイトは，ユーザーが利用登録をする際に氏名(ハンドルネーム），住所，メールアドレス，などの個人情報をお尋ねすることがあります。また，ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当サイトの提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。
        </p>
      </div>
      <div class="t_container">
        <p class="t_title">第3条（個人情報を収集・利用する目的）</p>
        <p class="t_text">
      ...
      <div class="t_container">
        <p class="t_title">第5条（個人情報の第三者提供）</p>
        <p class="t_text">
      ...
      <div class="t_container">
        <p class="t_title">第7条（個人情報の訂正および削除）</p>
        <p class="t_text">
      ...
      <div class="t_container">
        <p class="t_title">第8条（個人情報の利用停止等）</p>
        <p class="t_text">
      ...
      <div class="t_container">
        <p class="t_title">第9条（プライバシーポリシーの変更）</p>
        <p class="t_text">
      ...
      <div class="t_container">
        <p class="t_title">第10条（お問い合わせ窓口）</p>
        <p class="t_text">
